 ...
 */
final class Version20190917153926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE id id INTEGER AUTO_INCREMENT NOT NULL COMMENT \'(DC2Type:aggregateId_AutoIncrement)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE id id INTEGER NOT NULL COMMENT \'(DC2Type:aggregateId)\'');
