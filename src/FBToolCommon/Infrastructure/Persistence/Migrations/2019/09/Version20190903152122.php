 ...
 */
final class Version20190903152122 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX studiHash ON pruefung_studiPruefung (studiHash)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX studiHash ON pruefung_studiPruefung');
    }
}
