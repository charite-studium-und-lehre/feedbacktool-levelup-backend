...
final class Version20200127152404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pruefung_studiPruefung CHANGE pruefungs_id pruefungsId VARCHAR(30) NOT NULL COMMENT \'(DC2Type:pruefungsId)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pruefung_studiPruefung CHANGE pruefungsId pruefungs_id VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
